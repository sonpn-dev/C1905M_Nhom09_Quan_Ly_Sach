 ...
 * @author A_Muoi
 */
public class EditNxb extends javax.swing.JDialog {
    private ArrayList<Nxb> list;
    private int id;
    Nxb nxb;
    DAO dao;
//    public AddNxb(java.awt.Frame parent, boolean modal) {
//        super(parent, modal);
//        initComponents();
//        this.setLocationRelativeTo(null);   
//    }
    public EditNxb(java.awt.Frame parent, boolean modal, ArrayList<Nxb> list,int row) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        System.out.println("N:"+nxb);
        dao = new DAO();
        this.nxb = nxb;
        int count = 0;
            for (Nxb str : list) {
    ...
    public void initData(){
        if (nxb != null) {  
            EditName.setText(nxb.getName());
            EditAddress.setText(nxb.getAddress());
            EditEmail.setText(nxb.getEmail());
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(EditAddress, javax.swing.GroupLayout.DEFAULT_SIZE, 476, Short.MAX_VALUE)
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if(isOk){
            nxb.setName(EditName.getText());
            nxb.setAddress(EditAddress.getText());
            nxb.setEmail(EditEmail.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditNxb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditNxb dialog = new EditNxb(new javax.swing.JFrame(), true,null,0);
