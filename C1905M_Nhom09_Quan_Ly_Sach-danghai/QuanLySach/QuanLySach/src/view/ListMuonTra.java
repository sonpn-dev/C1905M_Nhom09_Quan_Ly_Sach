...
public class ListMuonTra extends javax.swing.JInternalFrame {
    ...
    public ListMuonTra() {
        initComponents();
        list = new DAO().getListMuonTra();
        model = (DefaultTableModel) tblSach.getModel();
        model.setColumnIdentifiers(new Object[]{
            "STT","Số thẻ","Tên độc giả","Tên nhân viên","Status","Ngày mượn"
        });
        showTable();
    }
    public void showTable(){
        ...
        model.addRow(new Object[]{
          b.getId(),b.getCard(), b.getUser(), b.getStaff(), b.getStatuts(), b.getBorrowed_date()
        });
        }
    }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        AddMuonTra addMuonTra = new AddMuonTra(frame,true,muonTra);
        addMuonTra.setVisible(true);
        list = new DAO().getListMuonTra();
        model.setRowCount(0);
        model = (DefaultTableModel) tblSach.getModel();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(id == -1){
            ...
            boolean ok = new DAO().removeMuonTra(id);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if(id == -1){
            ...
            EditMuonTra editMuonTra = new EditMuonTra(frame,true,list,row);
            editMuonTra.setVisible(true);
            list = new DAO().getListMuonTra();
            model.setRowCount(0);
            model = (DefaultTableModel) tblSach.getModel();
