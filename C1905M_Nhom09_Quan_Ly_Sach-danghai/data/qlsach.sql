...
go
Insert into nxb(name,address,email) Values 
(N'Kim Dong','so 3 NVC','Hai')
GO
...
GO
Insert into books(name,yearMaking,author_id,category_id,nxb_id) Values 
(N'Sach thieu nhi',1999,1,10,1)
GO
Select * from books
create table books
(
